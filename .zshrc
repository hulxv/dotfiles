...
export PATH=$HOME/bin:/usr/local/bin:$HOME/.cargo/bin:$HOME/.scripts:$HOME/.local/share/gem/ruby/3.0.0/bin:$PATH
...
alias startd="sudo systemctl enable --now"
alias stopd="sudo systemctl disable --now"
alias restartd="sudo systemctl restart"
alias reloadd="sudo systemctl reload"
